...
# Generated on: Thu Sep 03 10:36:51 IST 2026 (Thu Sep 03 05:06:51 UTC 2026)
...
set logfile fv/hearing/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/hearing -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  hearing.v
elaborate_design -golden -root {hearing} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/hearing/fv_map.v.gz
elaborate_design -revised -root {hearing}
...
#add_name_alias fv/hearing/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.hearing.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.hearing.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.hearing.rtl.fv_map.rpt
